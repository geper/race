...
namespace racing_simulation_2d
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void Init(Size size)
        {
            ...
            //устанавливаем 
            vehicle.Setup(new Vector(3, 8)/2.0f, 4, Color.Red);
    ...
    class Vehicle : RigidBody
    {
        ...
        /// 
        /// </summary>
        /// <param name="halfSize">Размеры </param>
        ...
        {
           // рулевое управление
            // вляет на повороты реакция на право в лево
        ...
        {
            // крутящий момент 
            //меняеться скорость разгона 
            const float torque = 80.0f;
     
            //применять передачу крутящего момента на задние колеса
        ...
        public void SetBrakes(float brakes)
        {
            ...
            //применять соединяющий тормозной момент колесо
    ...
    class RigidBody
    {
        ...
        public void Draw(Graphics graphics, Size buffersize)
        {
            ...
            Bitmap av=new Bitmap("avto.png");
            Rectangle avtoPos = new Rectangle(rect.X-10,rect.Y-10,rect.Width+20,rect.Height+20);
    ...
    #endregion
    //следить за временем между кадрами
    ...
    class Timer
    {
        ...
        //вычислить и вернуть время, прошедшее с последнего звонка
